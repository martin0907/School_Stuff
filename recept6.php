...
?>
    ...
    <div class="cardv">
    <h3>Srnčí tataráčik s prepeličími očami</h3>
        <?php
              $sql = "SELECT * FROM proba WHERE ID='14'";
            ...
            if(isset($_SESSION["useruid"])){
                echo "<form method='POST' action='".setCommentsSkRecept3($conn)."'> 
