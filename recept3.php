...
?>
    ...
    <div class="cardv">
    <h3>Crostini so špenátom a s prepeličím volským očkom</h3>
    <?php
              $sql = "SELECT * FROM proba WHERE ID='11'";
            ...
            if(isset($_SESSION["useruid"])){
                echo "<form method='POST' action='".setCommentsSkRecept4($conn)."'> 
