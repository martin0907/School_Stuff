...
?>
    ...
    <div class="cardv">
    <h3>Chutný zeleninový šalát s cottagge syrom a prepeličími vajíčkami</h3>
    <?php
              $sql = "SELECT * FROM proba WHERE ID='12'";
            ...
            if(isset($_SESSION["useruid"])){
                echo "<form method='POST' action='".setCommentsSkRecept5($conn)."'> 
